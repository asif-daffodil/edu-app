<x-modal name="auth-register" maxWidth="md" focusable>
    <div data-auth-modal="register" class="p-6 sm:p-7">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('frontend.register') }}</h2>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-200">{{ __('frontend.register_subtitle') }}</p>
            </div>
            ...
            <button type="button"
                    ...
                    x-on:click="$dispatch('close-modal', 'auth-register')"
                    aria-label="Close">
        ...
        <div data-auth-panel="register-form">
            ...
            <div>
                <label for="auth_register_name" class="text-sm font-medium text-slate-700 dark:text-slate-200">{{ __('frontend.name') }}</label>
                <input id="auth_register_name" type="text" name="name" value="{{ old('name') }}" autocomplete="name" required
                ...
                <div class="mt-2 text-sm text-rose-600" data-auth-error-for="name">
            ...
            <div class="mt-4">
                <label for="auth_register_email" class="text-sm font-medium text-slate-700 dark:text-slate-200">{{ __('frontend.email') }}</label>
                <input id="auth_register_email" type="email" name="email" value="{{ old('email') }}" autocomplete="username" required
                       class="mt-2 w-full rounded-xl border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-white/10 dark:bg-white/5 dark:text-white" />
            ...
            <div class="mt-4">
                <label for="auth_register_password" class="text-sm font-medium text-slate-700 dark:text-slate-200">{{ __('frontend.password') }}</label>
                <input id="auth_register_password" type="password" name="password" autocomplete="new-password" required
                       class="mt-2 w-full rounded-xl border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-white/10 dark:bg-white/5 dark:text-white" />
            ...
            <div class="mt-4">
                <label for="auth_register_password_confirmation" class="text-sm font-medium text-slate-700 dark:text-slate-200">{{ __('frontend.password_confirmation') }}</label>
                <input id="auth_register_password_confirmation" type="password" name="password_confirmation" autocomplete="new-password" required
                       class="mt-2 w-full rounded-xl border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:border-white/10 dark:bg-white/5 dark:text-white" />
                <div class="mt-2 text-sm text-rose-600" data-auth-error-for="password_confirmation">

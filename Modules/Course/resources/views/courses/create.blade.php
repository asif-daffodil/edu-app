        ...
        <form method="POST" action="{{ route('dashboard.courses.store') }}" enctype="multipart/form-data" class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200 space-y-5">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="number" name="old_price" value="{{ old('old_price') }}" min="0" step="0.01" class="mt-1 w-full rounded-lg border-slate-300" />
                ...
                <div>
                    ...
                    <input type="number" name="discount_price" value="{{ old('discount_price') }}" min="0" step="0.01" class="mt-1 w-full rounded-lg border-slate-300" />
